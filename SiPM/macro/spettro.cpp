...
{
  //=================================================
 // Macro per leggere file txt del SiPM

  // CAMBIARE: ch_inf, ch_sup, ngroup, fname
  ...
  // Definir sistema
  bool amptek = false;   // true: amptek, false: PCA, ICSW_Spectech
 ...
 string fname, filename;
  ...
  TH1F* hist=new TH1F("Histo1","Spettro globale",nchan/ngroup,ch_inf,ch_sup);
