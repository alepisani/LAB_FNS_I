void ajuste4picos()
{
  ...
  //
  //   Macro para ajustar cuatro picos gaussianos con un fondo lineal o exponencial
  ...
  // Definir sistema
  bool amptek = false;   // true para amptek, false para PCA y ICSW_Spectech
 ...
 // Definicion de los intervalos
  ...
  // Definir intervalo de la gaussiana 4
  int g4_ini, g4_fin;
     g4_ini= 2850;
     g4_fin= 3400;
...
// Funcion total como suma de las anteriores
  ...
  total->SetParName(11,"Amplitud 4");
...
// */
 ...
 // Gaussiana 4
  ...
  // dump canvas to pdf
  // c1->Print("ajuste4picos_espectro.pdf");  
  // c1->Print("ajuste4picos_espectro.png");  
  c2->Print("ajuste4picos.pdf");  
  // c2->Print("ajuste4picos.png");  
