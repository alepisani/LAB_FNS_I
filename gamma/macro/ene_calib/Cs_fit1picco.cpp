void Cs_fit1picco()
{
  ...
  // dichiarare histo
  TH1F* hist=new TH1F("Histo1","Spettro globale del ^{137}Cs",nchan/ngroup,0,nchan);
  TH1F* peak=new TH1F("Histo2","Fit del fotopicco da 662 keV del ^{137}Cs",nchan/ngroup_peak,0,nchan);
