void Co60_fit2picchi()
{
 ...
 // File di input dati
    fname = "Spettro_energia_ravvicinato_delay_ampl_0deg_Co60"; //cambiare questo, senza .mca
  ...
  TH1F* peak=new TH1F("Histo2","Fit dei fotopicchi da 1173 e 1333 keV del ^{60}Co",nchan/ngroup_peak,0,nchan);
...
// Funzione totale come somma delle altre tre
 ...
 // Prima approssimazione: fit del fondo e dei picchi separatamente
  ...
  peak->GetYaxis()->SetTitle("conteggi / 4 canali");
