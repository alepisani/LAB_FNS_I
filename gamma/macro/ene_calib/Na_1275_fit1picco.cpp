void Na_1275_fit1picco()
{
  ...
  TH1F* peak=new TH1F("Histo2","Fit del fotopicco da 1275 keV del ^{22}Na",nchan/ngroup_peak,0,nchan);
  ...
  hist->GetYaxis()->SetTitle("conteggi / 4 canali");
  hist->Draw();
 ...
 TF1 *bkg, *total;
  ...
  c2->Print(("../../plots/fit_Na_1275_" + fname + ".pdf").c_str());  
}
